...
console.log(createMenuItem("Steak", 69, "Dinner"))
console.log(createMenuItem("EggsNHashies", 14, "Breakfast"))
...
const burger = {
  ...
  sale: function(type) { 
    let bigSale = this.price * 0.25
    let smallSale = this.price * 0.10
    let newPrice = 0

    if(type === "teacher" || type === "student") { 
      newPrice = this.price - bigSale
      
      console.log(`Hello since you are a ${type}, you qualify for $${bigSale.toFixed(2)} off your order. Your new total is $${newPrice.toFixed(2)}.`)

    } else { 
      newPrice = this.price - smallSale

      console.log(`Great time to come in, you qualify for $${smallSale.toFixed(2)} off your order. Your new total is $${newPrice.toFixed(2)}.`)
...
const reviews = [{name: "Daniela", rating: 5, feedback:"Beautiful atmosphere and wonderful vegan options!"},
    ...
    {name: "Wen", rating: 4.5, feedback:"I don't leave my house often, but when I do, it's for burger place. Highly reccomend."},
    {name: "Brett", rating: 3, feedback: "great selection of snacks and a nice cafe area to get work done during the day."},
    {name: "Julius", rating: 2, feedback: "I was largely unimpressed by burger venue. Nothing special on the menu and too expensive. The atmosphere is polarizing, and not for me, but I think some would like it." },
...
/* STRETCH 3:  burger challenge is not related to the data above! 
